                    ...
                    if msg.contentType == 0:
                        if msg.toType in [0,2]:
                            if text.lower() == 'help':
                                ...
                                client.tag(receiver, "u652ecfe3db603bf12dbea1ca941ad2ab")
                                client.sendMessage(receiver, None, contentMetadata={'mid': "u652ecfe3db603bf12dbea1ca941ad2ab"}, contentType=13)
